...
<br>
<form method="POST" action="check.php?id=<?php echo $caid; ?>" id="form">
...
<div></div>
  ...
  <form class="form1">
    ...
    <div style="display: inline-flex;width:70%;font-family: sans-serif;font-size: 10;">
    <table style="width:120%;margin-left: 15%;" >
  <tr>
    <td rowspan="3" width="60%" >Description
      <br>
