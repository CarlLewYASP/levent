...
<div style="margin-bottom: 6%;margin-top: 0%;">
  ...
  <div style="display: inline-flex;width:100%;">
    ...
    <h4 style="visibility: <?php echo $socie ?>;"><?php echo "Society/Club: ".$society; ?></h4>
  </div>
  <div>
    <h4><img src="<?php echo $img; ?>" style="height: 70vh;margin-left: 50%;max-width: 55vh;object-fit: cover;"></h4>
  </div>
  </div>
