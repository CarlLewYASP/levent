...
<body>
  ...
  <form method="POST" action="register.php">
  	...
  	<div class="input-group">
  	  ...
  	  <input type="text" name="userID" placeholder="chinwei99" value="<?php echo $userID; ?>">
  	</div>
  	<div class="input-group">
  	  <label>Fullname</label>
  	  <input type="text" name="fullname" placeholder="Foong Chin Wei" value="<?php echo $fullname; ?>">
  	</div>
  	<div class="input-group">
